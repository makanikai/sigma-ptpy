...
class SigmaPTPy(SigmaPTP, USB):
    ...
    def set_cam_data_group1(self, **kwargs):
        return self.__set_cam_data_group('SigmaSetCamDataGroup1', _CamDataGroup1, kwargs)

    def set_cam_data_group2(self, **kwargs):
        return self.__set_cam_data_group('SigmaSetCamDataGroup2', _CamDataGroup2, kwargs)

    def set_cam_data_group3(self, **kwargs):
        return self.__set_cam_data_group('SigmaSetCamDataGroup3', _CamDataGroup3, kwargs)

    def __set_cam_data_group(self, opcode, schema, kwargs):
        data = _dict_to_payload_container(kwargs)
